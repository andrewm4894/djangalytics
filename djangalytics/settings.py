"""
Django settings for djangalytics project.
...
SECRET_KEY = 'django-insecure-dxl9*z-we2d8&pi+&s!yo#p5!27fw+)pw#ni61q)z&hm824b6c'
...
ROOT_URLCONF = 'djangalytics.urls'
...
WSGI_APPLICATION = 'djangalytics.wsgi.application'
